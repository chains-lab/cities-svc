...
func (q CityQ) Insert(ctx context.Context, input CityModels) error {
...
func (q CityQ) Get(ctx context.Context) (CityModels, error) {
...
func (q CityQ) Select(ctx context.Context) ([]CityModels, error) {
