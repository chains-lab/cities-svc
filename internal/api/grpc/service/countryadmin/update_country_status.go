...
func (s Service) UpdateCountryStatus(ctx context.Context, req *svc.UpdateCountryStatusRequest) (*countryProto.Country, error) {
	...
	logger.Log(ctx).Infof("country status updated by user %s for country ID %s", initiatorID, country.ID)
